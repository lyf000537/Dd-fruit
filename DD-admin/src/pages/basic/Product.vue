<template>
  <div class="product">
    ...
    <el-table  size="small" :data="products.list" @selection-change="idsChangeHandler" style="text-align:center">
      ...
      <el-table-column prop="name" label="水果名称"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="visible" @close="dialogCloseHandler">
      ...
      <el-form :model="form" :rules="rules" ref="productForm">
        <el-form-item label="水果名称" label-width="100px" prop="name">
          <el-input v-model="form.name" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="水果价格" label-width="100px" prop="price">
          <el-input v-model="form.price" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="水果状态" label-width="100px" prop="status">
        ...
        <el-form-item label="水果主图" label-width="100px" prop="photo">
          <el-upload
            class="upload-demo"
